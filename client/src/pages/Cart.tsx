...
const CartPage: React.FC = () => {
  ...
  const applicablePromotions = useMemo(() => {
    ...
    return activePromotions.filter((promo) => {
      ...
      if (promo.discountType !== "DISCOUNT_AMOUNT") return false;
      ...
      // Check if any condition group is satisfied
  ...
  }, [activePromotions, cart, selectedItemIds]);
  ...
  const handleCheckout = () => {
    ...
    navigate("/checkout", {
      state: {
        ...
        selectedPromotionIds: autoAppliedPromotionIds, // Pass all applicable promotions
      },
    });
  };
  ...
  return (
    <div style={{ padding: "24px 16px", maxWidth: 1200, margin: "0 auto" }}>
      ...
      >
        ...
        >
          {/* Order Summary - Promotions are auto-applied */}
